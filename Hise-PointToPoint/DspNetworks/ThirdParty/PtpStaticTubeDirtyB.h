...
template <int NV>
struct PtpStaticTubeDirtyB : public data::base
{
    SNEX_NODE(PtpStaticTubeDirtyB);

    struct MetadataClass { SN_NODE_ID("PtpStaticTubeDirtyB"); };
    ...
    PointToPoint::StaticTubeDirtyB effect;
