...
template <int NV>
struct PtpWardsAirlineGVC9056AToneStack : public data::base
{
    SNEX_NODE(PtpWardsAirlineGVC9056AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpWardsAirlineGVC9056AToneStack"); };
    ...
    PointToPoint::WardsAirlineGVC_9056AToneStack effect;
