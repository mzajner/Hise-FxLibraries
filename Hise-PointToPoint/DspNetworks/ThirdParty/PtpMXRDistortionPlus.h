...
template <int NV>
struct PtpMXRDistortionPlus : public data::base
{
    SNEX_NODE(PtpMXRDistortionPlus);

    struct MetadataClass { SN_NODE_ID("PtpMXRDistortionPlus"); };
    ...
    PointToPoint::MXRDistortionPlus effect;
