...
template <int NV>
struct PtpStaticBJTPNPGE : public data::base
{
    SNEX_NODE(PtpStaticBJTPNPGE);

    struct MetadataClass { SN_NODE_ID("PtpStaticBJTPNPGE"); };
    ...
    PointToPoint::StaticBJT_PNP_GE effect;
