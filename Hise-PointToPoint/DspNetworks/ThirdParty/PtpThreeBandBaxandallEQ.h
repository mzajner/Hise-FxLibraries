...
template <int NV>
struct PtpThreeBandBaxandallEQ : public data::base
{
    SNEX_NODE(PtpThreeBandBaxandallEQ);

    struct MetadataClass { SN_NODE_ID("PtpThreeBandBaxandallEQ"); };
    ...
    PointToPoint::ThreeBandBaxandallEQ effect;
