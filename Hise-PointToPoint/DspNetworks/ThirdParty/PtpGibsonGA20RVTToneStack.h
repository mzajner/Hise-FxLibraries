...
template <int NV>
struct PtpGibsonGA20RVTToneStack : public data::base
{
    SNEX_NODE(PtpGibsonGA20RVTToneStack);

    struct MetadataClass { SN_NODE_ID("PtpGibsonGA20RVTToneStack"); };
    ...
    PointToPoint::GibsonGA20RVTToneStack effect;
