...
template <int NV>
struct PtpButterworthSallenKeyHPF30Hz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyHPF30Hz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyHPF30Hz"); };
    ...
    PointToPoint::ButterworthSallenKeyHPF_30Hz effect;
