...
template <int NV>
struct PtpRolandCube60NormalToneStack : public data::base
{
    SNEX_NODE(PtpRolandCube60NormalToneStack);

    struct MetadataClass { SN_NODE_ID("PtpRolandCube60NormalToneStack"); };
    ...
    PointToPoint::RolandCube60NormalToneStack effect;
