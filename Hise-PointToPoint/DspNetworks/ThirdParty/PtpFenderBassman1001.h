...
template <int NV>
struct PtpFenderBassman1001 : public data::base
{
    SNEX_NODE(PtpFenderBassman1001);

    struct MetadataClass { SN_NODE_ID("PtpFenderBassman1001"); };
    ...
    PointToPoint::FenderBassman100_1 effect;
