...
template <int NV>
struct PtpBigMuffOutputBooster : public data::base
{
    SNEX_NODE(PtpBigMuffOutputBooster);

    struct MetadataClass { SN_NODE_ID("PtpBigMuffOutputBooster"); };
    ...
    PointToPoint::BigMuffOutputBooster effect;
