...
template <int NV>
struct PtpFenderBrownFaceToneStack : public data::base
{
    SNEX_NODE(PtpFenderBrownFaceToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFenderBrownFaceToneStack"); };
    ...
    PointToPoint::FenderBrownFaceToneStack effect;
