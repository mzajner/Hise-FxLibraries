...
template <int NV>
struct PtpAcoustic118ToneStack : public data::base
{
    SNEX_NODE(PtpAcoustic118ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAcoustic118ToneStack"); };
    ...
    PointToPoint::Acoustic118ToneStack effect;
