...
template <int NV>
struct PtpBiquadBPF : public data::base
{
    SNEX_NODE(PtpBiquadBPF);

    struct MetadataClass { SN_NODE_ID("PtpBiquadBPF"); };
    ...
    {
        {
            parameter::data p("Frequency Q", { 0.0, 1.0 });
