...
template <int NV>
struct PtpSoldanoSuperLead1002B : public data::base
{
    SNEX_NODE(PtpSoldanoSuperLead1002B);

    struct MetadataClass { SN_NODE_ID("PtpSoldanoSuperLead1002B"); };
    ...
    PointToPoint::SoldanoSuperLead100_2B effect;
