...
template <int NV>
struct PtpBossDS1OpAmpGainStage : public data::base
{
    SNEX_NODE(PtpBossDS1OpAmpGainStage);

    struct MetadataClass { SN_NODE_ID("PtpBossDS1OpAmpGainStage"); };
    ...
    PointToPoint::BossDS1OpAmpGainStage effect;
    ...
    {
        {
            parameter::data p("Distortion", { 0.0, 1.0 });
