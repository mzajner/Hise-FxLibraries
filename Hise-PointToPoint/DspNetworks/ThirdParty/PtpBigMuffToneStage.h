...
template <int NV>
struct PtpBigMuffToneStage : public data::base
{
    SNEX_NODE(PtpBigMuffToneStage);

    struct MetadataClass { SN_NODE_ID("PtpBigMuffToneStage"); };
    ...
    PointToPoint::BigMuffToneStage effect;
