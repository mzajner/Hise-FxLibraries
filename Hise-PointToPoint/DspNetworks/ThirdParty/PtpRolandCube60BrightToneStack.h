...
template <int NV>
struct PtpRolandCube60BrightToneStack : public data::base
{
    SNEX_NODE(PtpRolandCube60BrightToneStack);

    struct MetadataClass { SN_NODE_ID("PtpRolandCube60BrightToneStack"); };
    ...
    PointToPoint::RolandCube60BrightToneStack effect;
