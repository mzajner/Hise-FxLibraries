...
template <int NV>
struct PtpSubBesselSallenKeyHPF30Hz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyHPF30Hz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyHPF30Hz"); };
    ...
    PointToPoint::SubBesselSallenKeyHPF_30Hz effect;
