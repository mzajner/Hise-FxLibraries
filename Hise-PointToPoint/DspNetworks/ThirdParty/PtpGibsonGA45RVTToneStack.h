...
template <int NV>
struct PtpGibsonGA45RVTToneStack : public data::base
{
    SNEX_NODE(PtpGibsonGA45RVTToneStack);

    struct MetadataClass { SN_NODE_ID("PtpGibsonGA45RVTToneStack"); };
    ...
    PointToPoint::GibsonGA45RVTToneStack effect;
