...
template <int NV>
struct PtpButterworthSallenKeyHPF : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyHPF);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyHPF"); };
    ...
    PointToPoint::ButterworthSallenKeyHPF effect;
