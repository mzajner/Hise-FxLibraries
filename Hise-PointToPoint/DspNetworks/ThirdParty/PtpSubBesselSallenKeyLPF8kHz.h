...
template <int NV>
struct PtpSubBesselSallenKeyLPF8kHz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyLPF8kHz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyLPF8kHz"); };
    ...
    PointToPoint::SubBesselSallenKeyLPF_8kHz effect;
