...
template <int NV>
struct PtpFourOpAmpStateVariableBPF60HzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF60HzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF60HzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF_60Hz_A effect;
