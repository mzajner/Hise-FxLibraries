...
template <int NV>
struct PtpTwinTNotchFilter8kHz : public data::base
{
    SNEX_NODE(PtpTwinTNotchFilter8kHz);

    struct MetadataClass { SN_NODE_ID("PtpTwinTNotchFilter8kHz"); };
    ...
    PointToPoint::TwinTNotchFilter_8kHz effect;
