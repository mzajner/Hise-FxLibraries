...
template <int NV>
struct PtpSubBesselSallenKeyHPF120Hz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyHPF120Hz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyHPF120Hz"); };
    ...
    PointToPoint::SubBesselSallenKeyHPF_120Hz effect;
