...
template <int NV>
struct PtpStaticBJTPNPSI : public data::base
{
    SNEX_NODE(PtpStaticBJTPNPSI);

    struct MetadataClass { SN_NODE_ID("PtpStaticBJTPNPSI"); };
    ...
    PointToPoint::StaticBJT_PNP_SI effect;
