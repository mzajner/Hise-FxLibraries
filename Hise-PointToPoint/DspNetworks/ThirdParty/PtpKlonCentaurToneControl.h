...
template <int NV>
struct PtpKlonCentaurToneControl : public data::base
{
    SNEX_NODE(PtpKlonCentaurToneControl);

    struct MetadataClass { SN_NODE_ID("PtpKlonCentaurToneControl"); };
    ...
    PointToPoint::KlonCentaurToneControl effect;
