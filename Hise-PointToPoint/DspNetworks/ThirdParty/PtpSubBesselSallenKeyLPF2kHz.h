...
template <int NV>
struct PtpSubBesselSallenKeyLPF2kHz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyLPF2kHz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyLPF2kHz"); };
    ...
    PointToPoint::SubBesselSallenKeyLPF_2kHz effect;
