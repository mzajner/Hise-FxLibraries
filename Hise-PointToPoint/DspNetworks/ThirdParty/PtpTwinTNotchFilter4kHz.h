...
template <int NV>
struct PtpTwinTNotchFilter4kHz : public data::base
{
    SNEX_NODE(PtpTwinTNotchFilter4kHz);

    struct MetadataClass { SN_NODE_ID("PtpTwinTNotchFilter4kHz"); };
    ...
    PointToPoint::TwinTNotchFilter_4kHz effect;
