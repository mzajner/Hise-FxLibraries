...
template <int NV>
struct PtpAmpegBA115DToneStack : public data::base
{
    SNEX_NODE(PtpAmpegBA115DToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAmpegBA115DToneStack"); };
    ...
    PointToPoint::AmpegBA115DToneStack effect;
