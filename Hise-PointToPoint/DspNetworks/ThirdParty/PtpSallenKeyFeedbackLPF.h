...
template <int NV>
struct PtpSallenKeyFeedbackLPF : public data::base
{
    SNEX_NODE(PtpSallenKeyFeedbackLPF);

    struct MetadataClass { SN_NODE_ID("PtpSallenKeyFeedbackLPF"); };
    ...
    PointToPoint::SallenKeyFeedbackLPF effect;
