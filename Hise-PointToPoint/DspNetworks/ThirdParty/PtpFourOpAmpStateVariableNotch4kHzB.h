...
template <int NV>
struct PtpFourOpAmpStateVariableNotch4kHzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableNotch4kHzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableNotch4kHzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableNotch_4kHz_B effect;
