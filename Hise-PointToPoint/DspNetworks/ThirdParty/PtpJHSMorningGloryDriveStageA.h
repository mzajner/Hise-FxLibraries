...
template <int NV>
struct PtpJHSMorningGloryDriveStageA : public data::base
{
    SNEX_NODE(PtpJHSMorningGloryDriveStageA);

    struct MetadataClass { SN_NODE_ID("PtpJHSMorningGloryDriveStageA"); };
    ...
    PointToPoint::JHSMorningGloryDriveStage_A effect;
