...
template <int NV>
struct PtpFourOpAmpStateVariableLPF : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableLPF);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableLPF"); };
    ...
    PointToPoint::FourOpAmpStateVariableLPF effect;
