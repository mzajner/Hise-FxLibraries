...
template <int NV>
struct PtpWardsAirlineGDR8502AToneStack : public data::base
{
    SNEX_NODE(PtpWardsAirlineGDR8502AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpWardsAirlineGDR8502AToneStack"); };
    ...
    PointToPoint::WardsAirlineGDR_8502AToneStack effect;
