...
template <int NV>
struct PtpFullwaveRectifierSI : public data::base
{
    SNEX_NODE(PtpFullwaveRectifierSI);

    struct MetadataClass { SN_NODE_ID("PtpFullwaveRectifierSI"); };
    ...
    PointToPoint::FullwaveRectifierSI effect;
