...
template <int NV>
struct PtpButterworthSallenKeyHPF90Hz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyHPF90Hz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyHPF90Hz"); };
    ...
    PointToPoint::ButterworthSallenKeyHPF_90Hz effect;
