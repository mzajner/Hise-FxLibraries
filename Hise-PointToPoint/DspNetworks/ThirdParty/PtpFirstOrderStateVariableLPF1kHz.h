...
template <int NV>
struct PtpFirstOrderStateVariableLPF1kHz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableLPF1kHz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableLPF1kHz"); };
    ...
    PointToPoint::FirstOrderStateVariableLPF_1kHz effect;
