...
template <int NV>
struct PtpFourOpAmpStateVariableNotch4kHzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableNotch4kHzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableNotch4kHzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableNotch_4kHz_A effect;
