...
template <int NV>
struct PtpButterworthSallenKeyHPF60Hz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyHPF60Hz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyHPF60Hz"); };
    ...
    PointToPoint::ButterworthSallenKeyHPF_60Hz effect;
