...
template <int NV>
struct PtpStaticTubeDirtyA : public data::base
{
    SNEX_NODE(PtpStaticTubeDirtyA);

    struct MetadataClass { SN_NODE_ID("PtpStaticTubeDirtyA"); };
    ...
    PointToPoint::StaticTubeDirtyA effect;
