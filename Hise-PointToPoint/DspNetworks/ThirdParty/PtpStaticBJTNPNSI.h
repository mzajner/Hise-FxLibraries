...
template <int NV>
struct PtpStaticBJTNPNSI : public data::base
{
    SNEX_NODE(PtpStaticBJTNPNSI);

    struct MetadataClass { SN_NODE_ID("PtpStaticBJTNPNSI"); };
    ...
    PointToPoint::StaticBJT_NPN_SI effect;
