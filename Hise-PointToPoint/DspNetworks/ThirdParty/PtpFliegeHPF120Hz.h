...
template <int NV>
struct PtpFliegeHPF120Hz : public data::base
{
    SNEX_NODE(PtpFliegeHPF120Hz);

    struct MetadataClass { SN_NODE_ID("PtpFliegeHPF120Hz"); };
    ...
    PointToPoint::FliegeHPF_120Hz effect;
