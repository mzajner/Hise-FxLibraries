...
template <int NV>
struct PtpTubeDirtyBiasB : public data::base
{
    SNEX_NODE(PtpTubeDirtyBiasB);

    struct MetadataClass { SN_NODE_ID("PtpTubeDirtyBiasB"); };
    ...
    PointToPoint::TubeDirtyBiasB effect;
