...
template <int NV>
struct PtpLowPlusHighShelves : public data::base
{
    SNEX_NODE(PtpLowPlusHighShelves);

    struct MetadataClass { SN_NODE_ID("PtpLowPlusHighShelves"); };
    ...
    PointToPoint::LowPlusHighShelves effect;
