...
template <int NV>
struct PtpFourOpAmpStateVariableNotch8kHzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableNotch8kHzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableNotch8kHzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableNotch_8kHz_A effect;
