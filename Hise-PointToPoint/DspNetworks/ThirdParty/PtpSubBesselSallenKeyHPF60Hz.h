...
template <int NV>
struct PtpSubBesselSallenKeyHPF60Hz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyHPF60Hz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyHPF60Hz"); };
    ...
    PointToPoint::SubBesselSallenKeyHPF_60Hz effect;
