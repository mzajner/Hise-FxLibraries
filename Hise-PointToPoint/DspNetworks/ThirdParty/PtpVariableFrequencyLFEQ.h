...
template <int NV>
struct PtpVariableFrequencyLFEQ : public data::base
{
    SNEX_NODE(PtpVariableFrequencyLFEQ);

    struct MetadataClass { SN_NODE_ID("PtpVariableFrequencyLFEQ"); };
    ...
    PointToPoint::VariableFrequencyLFEQ effect;
