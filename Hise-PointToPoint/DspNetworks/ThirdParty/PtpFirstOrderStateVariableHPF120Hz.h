...
template <int NV>
struct PtpFirstOrderStateVariableHPF120Hz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableHPF120Hz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableHPF120Hz"); };
    ...
    PointToPoint::FirstOrderStateVariableHPF_120Hz effect;
