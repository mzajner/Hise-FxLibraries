...
template <int NV>
struct PtpFourOpAmpStateVariableBPF4kHzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF4kHzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF4kHzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF_4kHz_A effect;
