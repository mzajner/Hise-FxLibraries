...
template <int NV>
struct PtpAmpegB15Portaflex1B : public data::base
{
    SNEX_NODE(PtpAmpegB15Portaflex1B);

    struct MetadataClass { SN_NODE_ID("PtpAmpegB15Portaflex1B"); };
    ...
    PointToPoint::AmpegB15Portaflex1B effect;
