...
template <int NV>
struct PtpBognerEcstasyToneStack : public data::base
{
    SNEX_NODE(PtpBognerEcstasyToneStack);

    struct MetadataClass { SN_NODE_ID("PtpBognerEcstasyToneStack"); };
    ...
    PointToPoint::BognerEcstasyToneStack effect;
