...
template <int NV>
struct PtpAmpegB15PortaflexToneStack : public data::base
{
    SNEX_NODE(PtpAmpegB15PortaflexToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAmpegB15PortaflexToneStack"); };
    ...
    PointToPoint::AmpegB15PortaflexToneStack effect;
