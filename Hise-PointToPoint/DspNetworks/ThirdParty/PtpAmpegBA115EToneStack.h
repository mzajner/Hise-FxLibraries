...
template <int NV>
struct PtpAmpegBA115EToneStack : public data::base
{
    SNEX_NODE(PtpAmpegBA115EToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAmpegBA115EToneStack"); };
    ...
    PointToPoint::AmpegBA115EToneStack effect;
