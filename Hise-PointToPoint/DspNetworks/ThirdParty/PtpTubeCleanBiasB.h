...
template <int NV>
struct PtpTubeCleanBiasB : public data::base
{
    SNEX_NODE(PtpTubeCleanBiasB);

    struct MetadataClass { SN_NODE_ID("PtpTubeCleanBiasB"); };
    ...
    PointToPoint::TubeCleanBiasB effect;
