...
template <int NV>
struct PtpFenderBassmanToneStack : public data::base
{
    SNEX_NODE(PtpFenderBassmanToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFenderBassmanToneStack"); };
    ...
    PointToPoint::FenderBassmanToneStack effect;
