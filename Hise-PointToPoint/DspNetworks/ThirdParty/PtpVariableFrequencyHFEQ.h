...
template <int NV>
struct PtpVariableFrequencyHFEQ : public data::base
{
    SNEX_NODE(PtpVariableFrequencyHFEQ);

    struct MetadataClass { SN_NODE_ID("PtpVariableFrequencyHFEQ"); };
    ...
    PointToPoint::VariableFrequencyHFEQ effect;
