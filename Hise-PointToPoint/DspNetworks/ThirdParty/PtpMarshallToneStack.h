...
template <int NV>
struct PtpMarshallToneStack : public data::base
{
    SNEX_NODE(PtpMarshallToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMarshallToneStack"); };
    ...
    PointToPoint::MarshallToneStack effect;
