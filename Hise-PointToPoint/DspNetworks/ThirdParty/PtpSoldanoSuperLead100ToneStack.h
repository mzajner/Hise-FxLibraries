...
template <int NV>
struct PtpSoldanoSuperLead100ToneStack : public data::base
{
    SNEX_NODE(PtpSoldanoSuperLead100ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpSoldanoSuperLead100ToneStack"); };
    ...
    PointToPoint::SoldanoSuperLead100ToneStack effect;
