...
template <int NV>
struct PtpButterworthSallenKeyLPF4kHz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyLPF4kHz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyLPF4kHz"); };
    ...
    PointToPoint::ButterworthSallenKeyLPF_4kHz effect;
