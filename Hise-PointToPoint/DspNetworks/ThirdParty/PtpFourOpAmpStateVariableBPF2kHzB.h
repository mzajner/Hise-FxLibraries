...
template <int NV>
struct PtpFourOpAmpStateVariableBPF2kHzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF2kHzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF2kHzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF_2kHz_B effect;
