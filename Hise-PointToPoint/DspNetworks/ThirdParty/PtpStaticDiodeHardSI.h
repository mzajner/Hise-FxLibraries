...
template <int NV>
struct PtpStaticDiodeHardSI : public data::base
{
    SNEX_NODE(PtpStaticDiodeHardSI);

    struct MetadataClass { SN_NODE_ID("PtpStaticDiodeHardSI"); };
    ...
    PointToPoint::StaticDiodeHardSI effect;
