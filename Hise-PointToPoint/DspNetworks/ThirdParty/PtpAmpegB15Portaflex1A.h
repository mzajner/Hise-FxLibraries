...
template <int NV>
struct PtpAmpegB15Portaflex1A : public data::base
{
    SNEX_NODE(PtpAmpegB15Portaflex1A);

    struct MetadataClass { SN_NODE_ID("PtpAmpegB15Portaflex1A"); };
    ...
    PointToPoint::AmpegB15Portaflex1A effect;
