...
template <int NV>
struct PtpStaticDiodeSoftSI : public data::base
{
    SNEX_NODE(PtpStaticDiodeSoftSI);

    struct MetadataClass { SN_NODE_ID("PtpStaticDiodeSoftSI"); };
    ...
    PointToPoint::StaticDiodeSoftSI effect;
