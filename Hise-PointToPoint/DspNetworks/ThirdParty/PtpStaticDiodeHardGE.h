...
template <int NV>
struct PtpStaticDiodeHardGE : public data::base
{
    SNEX_NODE(PtpStaticDiodeHardGE);

    struct MetadataClass { SN_NODE_ID("PtpStaticDiodeHardGE"); };
    ...
    PointToPoint::StaticDiodeHardGE effect;
