...
template <int NV>
struct PtpDumbleRockToneStack : public data::base
{
    SNEX_NODE(PtpDumbleRockToneStack);

    struct MetadataClass { SN_NODE_ID("PtpDumbleRockToneStack"); };
    ...
    PointToPoint::DumbleRockToneStack effect;
