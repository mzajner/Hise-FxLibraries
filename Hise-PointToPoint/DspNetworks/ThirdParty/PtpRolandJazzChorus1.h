...
template <int NV>
struct PtpRolandJazzChorus1 : public data::base
{
    SNEX_NODE(PtpRolandJazzChorus1);

    struct MetadataClass { SN_NODE_ID("PtpRolandJazzChorus1"); };
    ...
    PointToPoint::RolandJazzChorus1 effect;
