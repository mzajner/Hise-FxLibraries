...
template <int NV>
struct PtpBlackstarHT5ToneStack : public data::base
{
    SNEX_NODE(PtpBlackstarHT5ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpBlackstarHT5ToneStack"); };
    ...
    PointToPoint::BlackstarHT5ToneStack effect;
