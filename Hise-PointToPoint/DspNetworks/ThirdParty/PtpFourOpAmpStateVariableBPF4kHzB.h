...
template <int NV>
struct PtpFourOpAmpStateVariableBPF4kHzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF4kHzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF4kHzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF_4kHz_B effect;
