...
template <int NV>
struct PtpFirstOrderStateVariableLPF2kHz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableLPF2kHz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableLPF2kHz"); };
    ...
    PointToPoint::FirstOrderStateVariableLPF_2kHz effect;
