...
template <int NV>
struct PtpJHSMorningGloryInputStage : public data::base
{
    SNEX_NODE(PtpJHSMorningGloryInputStage);

    struct MetadataClass { SN_NODE_ID("PtpJHSMorningGloryInputStage"); };
    ...
    PointToPoint::JHSMorningGloryInputStage effect;
