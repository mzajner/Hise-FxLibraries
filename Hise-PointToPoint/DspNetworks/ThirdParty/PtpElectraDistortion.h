...
template <int NV>
struct PtpElectraDistortion : public data::base
{
    SNEX_NODE(PtpElectraDistortion);

    struct MetadataClass { SN_NODE_ID("PtpElectraDistortion"); };
    ...
    PointToPoint::ElectraDistortion effect;
