...
template <int NV>
struct PtpFenderPrinceton5F2AToneStack : public data::base
{
    SNEX_NODE(PtpFenderPrinceton5F2AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFenderPrinceton5F2AToneStack"); };
    ...
    PointToPoint::FenderPrinceton5F2AToneStack effect;
