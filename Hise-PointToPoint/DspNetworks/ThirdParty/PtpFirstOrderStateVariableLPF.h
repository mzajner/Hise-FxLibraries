...
template <int NV>
struct PtpFirstOrderStateVariableLPF : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableLPF);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableLPF"); };
    ...
    PointToPoint::FirstOrderStateVariableLPF effect;
