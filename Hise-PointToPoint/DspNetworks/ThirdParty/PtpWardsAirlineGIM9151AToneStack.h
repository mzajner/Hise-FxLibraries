...
template <int NV>
struct PtpWardsAirlineGIM9151AToneStack : public data::base
{
    SNEX_NODE(PtpWardsAirlineGIM9151AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpWardsAirlineGIM9151AToneStack"); };
    ...
    PointToPoint::WardsAirlineGIM_9151AToneStack effect;
