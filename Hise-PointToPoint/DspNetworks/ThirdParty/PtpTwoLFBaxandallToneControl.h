...
template <int NV>
struct PtpTwoLFBaxandallToneControl : public data::base
{
    SNEX_NODE(PtpTwoLFBaxandallToneControl);

    struct MetadataClass { SN_NODE_ID("PtpTwoLFBaxandallToneControl"); };
    ...
    PointToPoint::TwoLFBaxandallToneControl effect;
