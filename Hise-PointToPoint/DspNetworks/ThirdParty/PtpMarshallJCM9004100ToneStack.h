...
template <int NV>
struct PtpMarshallJCM9004100ToneStack : public data::base
{
    SNEX_NODE(PtpMarshallJCM9004100ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMarshallJCM9004100ToneStack"); };
    ...
    PointToPoint::MarshallJCM900_4100ToneStack effect;
