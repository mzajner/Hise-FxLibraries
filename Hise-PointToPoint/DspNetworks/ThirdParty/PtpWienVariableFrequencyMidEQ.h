...
template <int NV>
struct PtpWienVariableFrequencyMidEQ : public data::base
{
    SNEX_NODE(PtpWienVariableFrequencyMidEQ);

    struct MetadataClass { SN_NODE_ID("PtpWienVariableFrequencyMidEQ"); };
    ...
    PointToPoint::WienVariableFrequencyMidEQ effect;
