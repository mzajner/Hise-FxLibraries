...
template <int NV>
struct PtpFourOpAmpStateVariableNotch : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableNotch);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableNotch"); };
    ...
    PointToPoint::FourOpAmpStateVariableNotch effect;
    ...
    {
        {
            parameter::data p("Cutoff", { 0.0, 1.0 });
