...
template <int NV>
struct PtpDumbleJazzToneStack : public data::base
{
    SNEX_NODE(PtpDumbleJazzToneStack);

    struct MetadataClass { SN_NODE_ID("PtpDumbleJazzToneStack"); };
    ...
    PointToPoint::DumbleJazzToneStack effect;
