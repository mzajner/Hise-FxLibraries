...
template <int NV>
struct PtpEpiphoneEA32RVTToneStack : public data::base
{
    SNEX_NODE(PtpEpiphoneEA32RVTToneStack);

    struct MetadataClass { SN_NODE_ID("PtpEpiphoneEA32RVTToneStack"); };
    ...
    PointToPoint::EpiphoneEA32RVTToneStack effect;
