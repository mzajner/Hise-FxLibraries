...
template <int NV>
struct PtpBognerEcstasy3 : public data::base
{
    SNEX_NODE(PtpBognerEcstasy3);

    struct MetadataClass { SN_NODE_ID("PtpBognerEcstasy3"); };
    ...
    PointToPoint::BognerEcstasy3 effect;
