...
template <int NV>
struct PtpFenderBassman1002B : public data::base
{
    SNEX_NODE(PtpFenderBassman1002B);

    struct MetadataClass { SN_NODE_ID("PtpFenderBassman1002B"); };
    ...
    PointToPoint::FenderBassman100_2B effect;
