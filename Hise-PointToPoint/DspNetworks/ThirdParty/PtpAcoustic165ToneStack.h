...
template <int NV>
struct PtpAcoustic165ToneStack : public data::base
{
    SNEX_NODE(PtpAcoustic165ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAcoustic165ToneStack"); };
    ...
    PointToPoint::Acoustic165ToneStack effect;
