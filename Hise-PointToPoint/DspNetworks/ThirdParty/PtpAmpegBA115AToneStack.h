...
template <int NV>
struct PtpAmpegBA115AToneStack : public data::base
{
    SNEX_NODE(PtpAmpegBA115AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAmpegBA115AToneStack"); };
    ...
    PointToPoint::AmpegBA115AToneStack effect;
