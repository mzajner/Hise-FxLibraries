...
template <int NV>
struct PtpSubBesselSallenKeyHPF : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyHPF);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyHPF"); };
    ...
    PointToPoint::SubBesselSallenKeyHPF effect;
