...
template <int NV>
struct PtpFourOpAmpStateVariableLPF8kHzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableLPF8kHzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableLPF8kHzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableLPF_8kHz_A effect;
