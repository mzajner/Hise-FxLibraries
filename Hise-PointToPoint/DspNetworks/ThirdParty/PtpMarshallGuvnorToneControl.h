...
template <int NV>
struct PtpMarshallGuvnorToneControl : public data::base
{
    SNEX_NODE(PtpMarshallGuvnorToneControl);

    struct MetadataClass { SN_NODE_ID("PtpMarshallGuvnorToneControl"); };
    ...
    PointToPoint::MarshallGuvnorToneControl effect;
