...
template <int NV>
struct PtpOrangeAD15ToneStack : public data::base
{
    SNEX_NODE(PtpOrangeAD15ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpOrangeAD15ToneStack"); };
    ...
    PointToPoint::OrangeAD15ToneStack effect;
