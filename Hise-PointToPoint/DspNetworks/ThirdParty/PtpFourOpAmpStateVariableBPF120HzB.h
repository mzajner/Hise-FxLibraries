...
template <int NV>
struct PtpFourOpAmpStateVariableBPF120HzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF120HzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF120HzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF_120Hz_B effect;
