...
template <int NV>
struct PtpMarshallJCM9002210SLXToneStack : public data::base
{
    SNEX_NODE(PtpMarshallJCM9002210SLXToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMarshallJCM9002210SLXToneStack"); };
    ...
    PointToPoint::MarshallJCM900_2210SLXToneStack effect;
