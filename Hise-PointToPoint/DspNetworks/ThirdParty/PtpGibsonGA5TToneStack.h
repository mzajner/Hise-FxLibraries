...
template <int NV>
struct PtpGibsonGA5TToneStack : public data::base
{
    SNEX_NODE(PtpGibsonGA5TToneStack);

    struct MetadataClass { SN_NODE_ID("PtpGibsonGA5TToneStack"); };
    ...
    PointToPoint::GibsonGA5TToneStack effect;
