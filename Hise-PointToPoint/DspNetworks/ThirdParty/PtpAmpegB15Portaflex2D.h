...
template <int NV>
struct PtpAmpegB15Portaflex2D : public data::base
{
    SNEX_NODE(PtpAmpegB15Portaflex2D);

    struct MetadataClass { SN_NODE_ID("PtpAmpegB15Portaflex2D"); };
    ...
    PointToPoint::AmpegB15Portaflex2D effect;
