...
template <int NV>
struct PtpButterworthSallenKeyLPF16kHz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyLPF16kHz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyLPF16kHz"); };
    ...
    PointToPoint::ButterworthSallenKeyLPF_16kHz effect;
