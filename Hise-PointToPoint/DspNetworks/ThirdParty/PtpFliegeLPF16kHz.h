...
template <int NV>
struct PtpFliegeLPF16kHz : public data::base
{
    SNEX_NODE(PtpFliegeLPF16kHz);

    struct MetadataClass { SN_NODE_ID("PtpFliegeLPF16kHz"); };
    ...
    PointToPoint::FliegeLPF_16kHz effect;
