...
template <int NV>
struct PtpSubBesselSallenKeyLPF16kHz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyLPF16kHz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyLPF16kHz"); };
    ...
    PointToPoint::SubBesselSallenKeyLPF_16kHz effect;
