...
template <int NV>
struct PtpSubBesselSallenKeyLPF4kHz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyLPF4kHz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyLPF4kHz"); };
    ...
    PointToPoint::SubBesselSallenKeyLPF_4kHz effect;
