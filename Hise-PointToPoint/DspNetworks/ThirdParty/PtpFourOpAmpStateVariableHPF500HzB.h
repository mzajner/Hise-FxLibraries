...
template <int NV>
struct PtpFourOpAmpStateVariableHPF500HzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableHPF500HzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableHPF500HzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableHPF_500Hz_B effect;
