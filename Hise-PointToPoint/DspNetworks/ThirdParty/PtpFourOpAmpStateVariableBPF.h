...
template <int NV>
struct PtpFourOpAmpStateVariableBPF : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF effect;
