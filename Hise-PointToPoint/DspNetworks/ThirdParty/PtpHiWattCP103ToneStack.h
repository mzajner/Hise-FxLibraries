...
template <int NV>
struct PtpHiWattCP103ToneStack : public data::base
{
    SNEX_NODE(PtpHiWattCP103ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpHiWattCP103ToneStack"); };
    ...
    PointToPoint::HiWattCP103ToneStack effect;
