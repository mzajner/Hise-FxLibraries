...
template <int NV>
struct PtpStaticBJTNPNGE : public data::base
{
    SNEX_NODE(PtpStaticBJTNPNGE);

    struct MetadataClass { SN_NODE_ID("PtpStaticBJTNPNGE"); };
    ...
    PointToPoint::StaticBJT_NPN_GE effect;
