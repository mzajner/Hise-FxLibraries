...
#include "src/PointToPoint/PedalCircuits.h"
...
template <int NV>
struct PtpMatchlessHotboxToneControl : public data::base
{
    SNEX_NODE(PtpMatchlessHotboxToneControl);

    struct MetadataClass { SN_NODE_ID("PtpMatchlessHotboxToneControl"); };
    ...
    PointToPoint::MatchlessHotboxToneControl effect;
    ...
    void createParameters(ParameterDataList& data)
    {
        ...
        {
            parameter::data p("Output", { 0.0, 1.0 });
