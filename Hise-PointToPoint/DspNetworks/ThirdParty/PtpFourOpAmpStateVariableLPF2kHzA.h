...
template <int NV>
struct PtpFourOpAmpStateVariableLPF2kHzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableLPF2kHzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableLPF2kHzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableLPF_2kHz_A effect;
