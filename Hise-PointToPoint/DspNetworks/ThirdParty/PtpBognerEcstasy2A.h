...
template <int NV>
struct PtpBognerEcstasy2A : public data::base
{
    SNEX_NODE(PtpBognerEcstasy2A);

    struct MetadataClass { SN_NODE_ID("PtpBognerEcstasy2A"); };
    ...
    PointToPoint::BognerEcstasy2A effect;
