...
template <int NV>
struct PtpWardsAirlineGVC9002AToneStack : public data::base
{
    SNEX_NODE(PtpWardsAirlineGVC9002AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpWardsAirlineGVC9002AToneStack"); };
    ...
    PointToPoint::WardsAirlineGVC_9002AToneStack effect;
