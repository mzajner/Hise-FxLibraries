...
template <int NV>
struct PtpStaticDiodeSoftGE : public data::base
{
    SNEX_NODE(PtpStaticDiodeSoftGE);

    struct MetadataClass { SN_NODE_ID("PtpStaticDiodeSoftGE"); };
    ...
    PointToPoint::StaticDiodeSoftGE effect;
