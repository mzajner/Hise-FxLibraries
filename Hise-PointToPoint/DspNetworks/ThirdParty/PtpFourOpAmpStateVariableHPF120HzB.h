...
template <int NV>
struct PtpFourOpAmpStateVariableHPF120HzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableHPF120HzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableHPF120HzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableHPF_120Hz_B effect;
