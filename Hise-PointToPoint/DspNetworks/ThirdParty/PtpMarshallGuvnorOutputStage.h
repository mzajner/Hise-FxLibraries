...
template <int NV>
struct PtpMarshallGuvnorOutputStage : public data::base
{
    SNEX_NODE(PtpMarshallGuvnorOutputStage);

    struct MetadataClass { SN_NODE_ID("PtpMarshallGuvnorOutputStage"); };
    ...
    PointToPoint::MarshallGuvnorOutputStage effect;
