...
template <int NV>
struct PtpBaxandall63Band : public data::base
{
    SNEX_NODE(PtpBaxandall63Band);

    struct MetadataClass { SN_NODE_ID("PtpBaxandall63Band"); };
    ...
    PointToPoint::Baxandall63Band effect;
    ...
    void createParameters(ParameterDataList& data)
    {
        ...
        {
            parameter::data p("Balance", { 0.0, 1.0 });
