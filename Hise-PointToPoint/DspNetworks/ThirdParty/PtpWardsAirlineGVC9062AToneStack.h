...
template <int NV>
struct PtpWardsAirlineGVC9062AToneStack : public data::base
{
    SNEX_NODE(PtpWardsAirlineGVC9062AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpWardsAirlineGVC9062AToneStack"); };
    ...
    PointToPoint::WardsAirlineGVC_9062AToneStack effect;
