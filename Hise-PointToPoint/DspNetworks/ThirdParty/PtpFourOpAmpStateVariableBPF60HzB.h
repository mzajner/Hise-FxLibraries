...
template <int NV>
struct PtpFourOpAmpStateVariableBPF60HzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF60HzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF60HzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF_60Hz_B effect;
