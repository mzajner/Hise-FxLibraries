...
template <int NV>
struct PtpRolandJazzChorus2A : public data::base
{
    SNEX_NODE(PtpRolandJazzChorus2A);

    struct MetadataClass { SN_NODE_ID("PtpRolandJazzChorus2A"); };
    ...
    PointToPoint::RolandJazzChorus2A effect;
