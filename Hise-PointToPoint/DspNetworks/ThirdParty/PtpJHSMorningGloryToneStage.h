...
template <int NV>
struct PtpJHSMorningGloryToneStage : public data::base
{
    SNEX_NODE(PtpJHSMorningGloryToneStage);

    struct MetadataClass { SN_NODE_ID("PtpJHSMorningGloryToneStage"); };
    ...
    PointToPoint::JHSMorningGloryToneStage effect;
