...
template <int NV>
struct PtpAllPassFilter : public data::base
{
    SNEX_NODE(PtpAllPassFilter);

    struct MetadataClass { SN_NODE_ID("PtpAllPassFilter"); };
    ...
    PointToPoint::AllPassFilter effect;
    ...
    {
        {
            parameter::data p("Phase", { 0.0, 1.0 });
