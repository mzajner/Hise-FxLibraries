...
template <int NV>
struct PtpSubBesselSallenKeyLPF : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyLPF);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyLPF"); };
    ...
    PointToPoint::SubBesselSallenKeyLPF effect;
