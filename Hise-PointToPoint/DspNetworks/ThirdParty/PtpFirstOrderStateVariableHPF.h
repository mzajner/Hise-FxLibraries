...
template <int NV>
struct PtpFirstOrderStateVariableHPF : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableHPF);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableHPF"); };
    ...
    PointToPoint::FirstOrderStateVariableHPF effect;
