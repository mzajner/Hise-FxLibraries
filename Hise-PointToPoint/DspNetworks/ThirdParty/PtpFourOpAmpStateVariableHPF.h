...
template <int NV>
struct PtpFourOpAmpStateVariableHPF : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableHPF);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableHPF"); };
    ...
    PointToPoint::FourOpAmpStateVariableHPF effect;
