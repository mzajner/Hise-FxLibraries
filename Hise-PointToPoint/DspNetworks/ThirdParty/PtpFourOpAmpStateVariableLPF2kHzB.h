...
template <int NV>
struct PtpFourOpAmpStateVariableLPF2kHzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableLPF2kHzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableLPF2kHzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableLPF_2kHz_B effect;
