...
template <int NV>
struct PtpButterworthSallenKeyHPF120Hz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyHPF120Hz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyHPF120Hz"); };
    ...
    PointToPoint::ButterworthSallenKeyHPF_120Hz effect;
