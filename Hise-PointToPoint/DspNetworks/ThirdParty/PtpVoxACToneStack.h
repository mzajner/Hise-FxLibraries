...
template <int NV>
struct PtpVoxACToneStack : public data::base
{
    SNEX_NODE(PtpVoxACToneStack);

    struct MetadataClass { SN_NODE_ID("PtpVoxACToneStack"); };
    ...
    PointToPoint::VoxACToneStack effect;
