...
template <int NV>
struct PtpFourOpAmpStateVariableHPF500HzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableHPF500HzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableHPF500HzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableHPF_500Hz_A effect;
