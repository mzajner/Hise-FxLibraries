...
template <int NV>
struct PtpStaticTubeCleanA : public data::base
{
    SNEX_NODE(PtpStaticTubeCleanA);

    struct MetadataClass { SN_NODE_ID("PtpStaticTubeCleanA"); };
    ...
    PointToPoint::StaticTubeCleanA effect;
