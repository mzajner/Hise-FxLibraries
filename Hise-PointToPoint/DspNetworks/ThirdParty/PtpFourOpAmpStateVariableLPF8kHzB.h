...
template <int NV>
struct PtpFourOpAmpStateVariableLPF8kHzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableLPF8kHzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableLPF8kHzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableLPF_8kHz_B effect;
