...
template <int NV>
struct PtpMarshallGuvnorClippingStage : public data::base
{
    SNEX_NODE(PtpMarshallGuvnorClippingStage);

    struct MetadataClass { SN_NODE_ID("PtpMarshallGuvnorClippingStage"); };
    ...
    PointToPoint::MarshallGuvnorClippingStage effect;
