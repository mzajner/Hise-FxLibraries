...
template <int NV>
struct PtpMarshallGuvnorInputStage : public data::base
{
    SNEX_NODE(PtpMarshallGuvnorInputStage);

    struct MetadataClass { SN_NODE_ID("PtpMarshallGuvnorInputStage"); };
    ...
    PointToPoint::MarshallGuvnorInputStage effect;
