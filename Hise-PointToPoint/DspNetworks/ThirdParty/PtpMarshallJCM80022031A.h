...
template <int NV>
struct PtpMarshallJCM80022031A : public data::base
{
    SNEX_NODE(PtpMarshallJCM80022031A);

    struct MetadataClass { SN_NODE_ID("PtpMarshallJCM80022031A"); };
    ...
    PointToPoint::MarshallJCM800_2203_1A effect;
