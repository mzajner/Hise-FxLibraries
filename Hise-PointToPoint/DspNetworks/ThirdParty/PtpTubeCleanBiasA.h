...
template <int NV>
struct PtpTubeCleanBiasA : public data::base
{
    SNEX_NODE(PtpTubeCleanBiasA);

    struct MetadataClass { SN_NODE_ID("PtpTubeCleanBiasA"); };
    ...
    PointToPoint::TubeCleanBiasA effect;
