...
template <int NV>
struct PtpTubeDirtyBiasA : public data::base
{
    SNEX_NODE(PtpTubeDirtyBiasA);

    struct MetadataClass { SN_NODE_ID("PtpTubeDirtyBiasA"); };
    ...
    PointToPoint::TubeDirtyBiasA effect;
