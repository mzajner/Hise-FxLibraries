...
template <int NV>
struct PtpFourOpAmpStateVariableBPF120HzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableBPF120HzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableBPF120HzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableBPF_120Hz_A effect;
