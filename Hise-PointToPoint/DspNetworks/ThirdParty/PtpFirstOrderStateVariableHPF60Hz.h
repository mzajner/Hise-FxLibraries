...
template <int NV>
struct PtpFirstOrderStateVariableHPF60Hz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableHPF60Hz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableHPF60Hz"); };
    ...
    PointToPoint::FirstOrderStateVariableHPF_60Hz effect;
