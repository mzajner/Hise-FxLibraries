...
template <int NV>
struct PtpBognerEcstasy2B : public data::base
{
    SNEX_NODE(PtpBognerEcstasy2B);

    struct MetadataClass { SN_NODE_ID("PtpBognerEcstasy2B"); };
    ...
    PointToPoint::BognerEcstasy2B effect;
