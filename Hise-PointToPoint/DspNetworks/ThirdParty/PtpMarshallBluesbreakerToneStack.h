...
template <int NV>
struct PtpMarshallBluesbreakerToneStack : public data::base
{
    SNEX_NODE(PtpMarshallBluesbreakerToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMarshallBluesbreakerToneStack"); };
    ...
    PointToPoint::MarshallBluesbreakerToneStack effect;
