...
template <int NV>
struct PtpGibsonGA16TToneStack : public data::base
{
    SNEX_NODE(PtpGibsonGA16TToneStack);

    struct MetadataClass { SN_NODE_ID("PtpGibsonGA16TToneStack"); };
    ...
    PointToPoint::GibsonGA16TToneStack effect;
