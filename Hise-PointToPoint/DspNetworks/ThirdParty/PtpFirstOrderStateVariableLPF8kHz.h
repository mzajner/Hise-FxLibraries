...
template <int NV>
struct PtpFirstOrderStateVariableLPF8kHz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableLPF8kHz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableLPF8kHz"); };
    ...
    PointToPoint::FirstOrderStateVariableLPF_8kHz effect;
