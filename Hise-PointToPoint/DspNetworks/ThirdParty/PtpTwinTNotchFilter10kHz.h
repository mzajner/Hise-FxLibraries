...
template <int NV>
struct PtpTwinTNotchFilter10kHz : public data::base
{
    SNEX_NODE(PtpTwinTNotchFilter10kHz);

    struct MetadataClass { SN_NODE_ID("PtpTwinTNotchFilter10kHz"); };
    ...
    PointToPoint::TwinTNotchFilter_10kHz effect;
