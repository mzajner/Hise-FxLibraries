...
template <int NV>
struct PtpAmpegB15Portaflex2B : public data::base
{
    SNEX_NODE(PtpAmpegB15Portaflex2B);

    struct MetadataClass { SN_NODE_ID("PtpAmpegB15Portaflex2B"); };
    ...
    PointToPoint::AmpegB15Portaflex2B effect;
