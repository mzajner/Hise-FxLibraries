...
template <int NV>
struct PtpFourOpAmpStateVariableHPF120HzA : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableHPF120HzA);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableHPF120HzA"); };
    ...
    PointToPoint::FourOpAmpStateVariableHPF_120Hz_A effect;
