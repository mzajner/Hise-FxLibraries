...
template <int NV>
struct PtpHalfwaveRectifierSI : public data::base
{
    SNEX_NODE(PtpHalfwaveRectifierSI);

    struct MetadataClass { SN_NODE_ID("PtpHalfwaveRectifierSI"); };
    ...
    PointToPoint::HalfwaveRectifierSI effect;
