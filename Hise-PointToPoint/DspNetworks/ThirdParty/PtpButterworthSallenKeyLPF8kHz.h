...
template <int NV>
struct PtpButterworthSallenKeyLPF8kHz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyLPF8kHz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyLPF8kHz"); };
    ...
    PointToPoint::ButterworthSallenKeyLPF_8kHz effect;
