...
template <int NV>
struct PtpAmpegB15Portaflex2C : public data::base
{
    SNEX_NODE(PtpAmpegB15Portaflex2C);

    struct MetadataClass { SN_NODE_ID("PtpAmpegB15Portaflex2C"); };
    ...
    PointToPoint::AmpegB15Portaflex2C effect;
