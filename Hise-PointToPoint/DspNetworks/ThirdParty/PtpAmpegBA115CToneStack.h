...
template <int NV>
struct PtpAmpegBA115CToneStack : public data::base
{
    SNEX_NODE(PtpAmpegBA115CToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAmpegBA115CToneStack"); };
    ...
    PointToPoint::AmpegBA115CToneStack effect;
