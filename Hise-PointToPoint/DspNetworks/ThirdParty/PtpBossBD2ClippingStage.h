...
template <int NV>
struct PtpBossBD2ClippingStage : public data::base
{
    SNEX_NODE(PtpBossBD2ClippingStage);

    struct MetadataClass { SN_NODE_ID("PtpBossBD2ClippingStage"); };
    ...
    PointToPoint::BossBD2ClippingStage effect;
