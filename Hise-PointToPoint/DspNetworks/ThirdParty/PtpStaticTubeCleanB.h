...
template <int NV>
struct PtpStaticTubeCleanB : public data::base
{
    SNEX_NODE(PtpStaticTubeCleanB);

    struct MetadataClass { SN_NODE_ID("PtpStaticTubeCleanB"); };
    ...
    PointToPoint::StaticTubeCleanB effect;
