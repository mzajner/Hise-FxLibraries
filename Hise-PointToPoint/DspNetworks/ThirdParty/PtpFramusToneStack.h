...
template <int NV>
struct PtpFramusToneStack : public data::base
{
    SNEX_NODE(PtpFramusToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFramusToneStack"); };
    ...
    PointToPoint::FramusToneStack effect;
