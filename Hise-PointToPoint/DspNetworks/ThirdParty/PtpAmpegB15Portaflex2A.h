...
template <int NV>
struct PtpAmpegB15Portaflex2A : public data::base
{
    SNEX_NODE(PtpAmpegB15Portaflex2A);

    struct MetadataClass { SN_NODE_ID("PtpAmpegB15Portaflex2A"); };
    ...
    PointToPoint::AmpegB15Portaflex2A effect;
