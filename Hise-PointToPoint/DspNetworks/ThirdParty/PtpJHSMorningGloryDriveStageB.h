...
template <int NV>
struct PtpJHSMorningGloryDriveStageB : public data::base
{
    SNEX_NODE(PtpJHSMorningGloryDriveStageB);

    struct MetadataClass { SN_NODE_ID("PtpJHSMorningGloryDriveStageB"); };
    ...
    PointToPoint::JHSMorningGloryDriveStage_B effect;
