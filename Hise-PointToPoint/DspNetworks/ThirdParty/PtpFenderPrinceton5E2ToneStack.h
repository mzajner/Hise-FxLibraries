...
template <int NV>
struct PtpFenderPrinceton5E2ToneStack : public data::base
{
    SNEX_NODE(PtpFenderPrinceton5E2ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFenderPrinceton5E2ToneStack"); };
    ...
    PointToPoint::FenderPrinceton5E2ToneStack effect;
