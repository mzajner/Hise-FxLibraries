...
template <int NV>
struct PtpFirstOrderStateVariableHPF500Hz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableHPF500Hz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableHPF500Hz"); };
    ...
    PointToPoint::FirstOrderStateVariableHPF_500Hz effect;
