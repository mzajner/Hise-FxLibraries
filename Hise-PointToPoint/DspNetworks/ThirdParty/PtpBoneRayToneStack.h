...
template <int NV>
struct PtpBoneRayToneStack : public data::base
{
    SNEX_NODE(PtpBoneRayToneStack);

    struct MetadataClass { SN_NODE_ID("PtpBoneRayToneStack"); };
    ...
    PointToPoint::BoneRayToneStack effect;
