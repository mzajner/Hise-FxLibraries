...
template <int NV>
struct PtpButterworthSallenKeyLPF : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyLPF);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyLPF"); };
    ...
    PointToPoint::ButterworthSallenKeyLPF effect;
