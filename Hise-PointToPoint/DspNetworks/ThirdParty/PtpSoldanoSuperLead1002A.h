...
#include "src/PointToPoint/AmpClippers.h"
...
template <int NV>
struct PtpSoldanoSuperLead1002A : public data::base
{
    SNEX_NODE(PtpSoldanoSuperLead1002A);

    struct MetadataClass { SN_NODE_ID("PtpSoldanoSuperLead1002A"); };
    ...
    PointToPoint::SoldanoSuperLead100_2A effect;
