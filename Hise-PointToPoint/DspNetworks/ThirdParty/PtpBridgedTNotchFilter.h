...
template <int NV>
struct PtpBridgedTNotchFilter : public data::base
{
    SNEX_NODE(PtpBridgedTNotchFilter);

    struct MetadataClass { SN_NODE_ID("PtpBridgedTNotchFilter"); };
    ...
    PointToPoint::BridgedTNotchFilter effect;
