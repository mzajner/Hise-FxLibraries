...
template <int NV>
struct PtpButterworthSallenKeyLPF2kHz : public data::base
{
    SNEX_NODE(PtpButterworthSallenKeyLPF2kHz);

    struct MetadataClass { SN_NODE_ID("PtpButterworthSallenKeyLPF2kHz"); };
    ...
    PointToPoint::ButterworthSallenKeyLPF_2kHz effect;
