...
template <int NV>
struct PtpTwinTNotchFilter6kHz : public data::base
{
    SNEX_NODE(PtpTwinTNotchFilter6kHz);

    struct MetadataClass { SN_NODE_ID("PtpTwinTNotchFilter6kHz"); };
    ...
    PointToPoint::TwinTNotchFilter_6kHz effect;
