...
template <int NV>
struct PtpTubeScreamerToneStage : public data::base
{
    SNEX_NODE(PtpTubeScreamerToneStage);

    struct MetadataClass { SN_NODE_ID("PtpTubeScreamerToneStage"); };
    ...
    PointToPoint::TubeScreamerToneStage effect;
