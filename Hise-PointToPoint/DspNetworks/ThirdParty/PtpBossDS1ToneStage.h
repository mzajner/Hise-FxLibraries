...
template <int NV>
struct PtpBossDS1ToneStage : public data::base
{
    SNEX_NODE(PtpBossDS1ToneStage);

    struct MetadataClass { SN_NODE_ID("PtpBossDS1ToneStage"); };
    ...
    PointToPoint::BossDS1ToneStage effect;
