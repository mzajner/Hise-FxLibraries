...
template <int NV>
struct PtpFenderBlondeTwinToneStack : public data::base
{
    SNEX_NODE(PtpFenderBlondeTwinToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFenderBlondeTwinToneStack"); };
    ...
    PointToPoint::FenderBlondeTwinToneStack effect;
