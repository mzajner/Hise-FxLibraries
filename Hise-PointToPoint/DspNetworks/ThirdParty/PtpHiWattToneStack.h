...
template <int NV>
struct PtpHiWattToneStack : public data::base
{
    SNEX_NODE(PtpHiWattToneStack);

    struct MetadataClass { SN_NODE_ID("PtpHiWattToneStack"); };
    ...
    PointToPoint::HiWattToneStack effect;
