...
template <int NV>
struct PtpRolandJazzChorus2B : public data::base
{
    SNEX_NODE(PtpRolandJazzChorus2B);

    struct MetadataClass { SN_NODE_ID("PtpRolandJazzChorus2B"); };
    ...
    PointToPoint::RolandJazzChorus2B effect;
