...
template <int NV>
struct PtpMarshallPlexiToneStack : public data::base
{
    SNEX_NODE(PtpMarshallPlexiToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMarshallPlexiToneStack"); };
    ...
    PointToPoint::MarshallPlexiToneStack effect;
