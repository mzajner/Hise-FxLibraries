...
template <int NV>
struct PtpTubeScreamerInputBuffer : public data::base
{
    SNEX_NODE(PtpTubeScreamerInputBuffer);

    struct MetadataClass { SN_NODE_ID("PtpTubeScreamerInputBuffer"); };
    ...
    PointToPoint::TubeScreamerInputBuffer effect;
