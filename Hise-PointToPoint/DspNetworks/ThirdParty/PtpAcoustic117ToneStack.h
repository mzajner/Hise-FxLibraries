...
template <int NV>
struct PtpAcoustic117ToneStack : public data::base
{
    SNEX_NODE(PtpAcoustic117ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAcoustic117ToneStack"); };
    ...
    PointToPoint::Acoustic117ToneStack effect;
