...
template <int NV>
struct PtpBognerEcstasy1 : public data::base
{
    SNEX_NODE(PtpBognerEcstasy1);

    struct MetadataClass { SN_NODE_ID("PtpBognerEcstasy1"); };
    ...
    PointToPoint::BognerEcstasy1 effect;
