...
template <int NV>
struct PtpWardsAirlineGDR8516AToneStack : public data::base
{
    SNEX_NODE(PtpWardsAirlineGDR8516AToneStack);

    struct MetadataClass { SN_NODE_ID("PtpWardsAirlineGDR8516AToneStack"); };
    ...
    PointToPoint::WardsAirlineGDR_8516AToneStack effect;
