...
template <int NV>
struct PtpAmpegBA115BToneStack : public data::base
{
    SNEX_NODE(PtpAmpegBA115BToneStack);

    struct MetadataClass { SN_NODE_ID("PtpAmpegBA115BToneStack"); };
    ...
    PointToPoint::AmpegBA115BToneStack effect;
