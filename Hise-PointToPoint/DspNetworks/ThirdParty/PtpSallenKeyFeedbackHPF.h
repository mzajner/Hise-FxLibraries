...
template <int NV>
struct PtpSallenKeyFeedbackHPF : public data::base
{
    SNEX_NODE(PtpSallenKeyFeedbackHPF);

    struct MetadataClass { SN_NODE_ID("PtpSallenKeyFeedbackHPF"); };
    ...
    PointToPoint::SallenKeyFeedbackHPF effect;
