...
template <int NV>
struct PtpBadCatHotcat30ToneStack : public data::base
{
    SNEX_NODE(PtpBadCatHotcat30ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpBadCatHotcat30ToneStack"); };
    ...
    PointToPoint::BadCatHotcat30ToneStack effect;
