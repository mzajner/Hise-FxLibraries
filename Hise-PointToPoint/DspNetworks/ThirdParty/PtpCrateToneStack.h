...
template <int NV>
struct PtpCrateToneStack : public data::base
{
    SNEX_NODE(PtpCrateToneStack);

    struct MetadataClass { SN_NODE_ID("PtpCrateToneStack"); };
    ...
    PointToPoint::CrateToneStack effect;
