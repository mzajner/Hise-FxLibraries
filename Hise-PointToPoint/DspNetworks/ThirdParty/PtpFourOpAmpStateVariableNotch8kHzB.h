...
template <int NV>
struct PtpFourOpAmpStateVariableNotch8kHzB : public data::base
{
    SNEX_NODE(PtpFourOpAmpStateVariableNotch8kHzB);

    struct MetadataClass { SN_NODE_ID("PtpFourOpAmpStateVariableNotch8kHzB"); };
    ...
    PointToPoint::FourOpAmpStateVariableNotch_8kHz_B effect;
