...
template <int NV>
struct PtpFenderESeriesToneStack : public data::base
{
    SNEX_NODE(PtpFenderESeriesToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFenderESeriesToneStack"); };
    ...
    PointToPoint::FenderESeriesToneStack effect;
