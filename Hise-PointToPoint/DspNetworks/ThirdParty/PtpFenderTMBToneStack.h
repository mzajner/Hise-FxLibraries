...
template <int NV>
struct PtpFenderTMBToneStack : public data::base
{
    SNEX_NODE(PtpFenderTMBToneStack);

    struct MetadataClass { SN_NODE_ID("PtpFenderTMBToneStack"); };
    ...
    PointToPoint::FenderTMBToneStack effect;
