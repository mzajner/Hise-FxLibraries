...
template <int NV>
struct PtpFirstOrderStateVariableHPF250Hz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableHPF250Hz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableHPF250Hz"); };
    ...
    PointToPoint::FirstOrderStateVariableHPF_250Hz effect;
