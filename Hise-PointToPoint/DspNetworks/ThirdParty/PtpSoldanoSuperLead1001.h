...
template <int NV>
struct PtpSoldanoSuperLead1001 : public data::base
{
    SNEX_NODE(PtpSoldanoSuperLead1001);

    struct MetadataClass { SN_NODE_ID("PtpSoldanoSuperLead1001"); };
    ...
    PointToPoint::SoldanoSuperLead100_1 effect;
