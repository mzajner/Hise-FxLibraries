...
template <int NV>
struct PtpGibsonGA75ToneStack : public data::base
{
    SNEX_NODE(PtpGibsonGA75ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpGibsonGA75ToneStack"); };
    ...
    PointToPoint::GibsonGA75ToneStack effect;
