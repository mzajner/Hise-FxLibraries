...
template <int NV>
struct PtpSubBesselSallenKeyHPF90Hz : public data::base
{
    SNEX_NODE(PtpSubBesselSallenKeyHPF90Hz);

    struct MetadataClass { SN_NODE_ID("PtpSubBesselSallenKeyHPF90Hz"); };
    ...
    PointToPoint::SubBesselSallenKeyHPF_90Hz effect;
