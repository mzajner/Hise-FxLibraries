...
template <int NV>
struct PtpMoonlightToneStack : public data::base
{
    SNEX_NODE(PtpMoonlightToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMoonlightToneStack"); };
    ...
    PointToPoint::MoonlightToneStack effect;
