...
template <int NV>
struct PtpFirstOrderStateVariableLPF4kHz : public data::base
{
    SNEX_NODE(PtpFirstOrderStateVariableLPF4kHz);

    struct MetadataClass { SN_NODE_ID("PtpFirstOrderStateVariableLPF4kHz"); };
    ...
    PointToPoint::FirstOrderStateVariableLPF_4kHz effect;
