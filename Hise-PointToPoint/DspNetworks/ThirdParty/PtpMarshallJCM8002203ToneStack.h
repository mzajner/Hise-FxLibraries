...
template <int NV>
struct PtpMarshallJCM8002203ToneStack : public data::base
{
    SNEX_NODE(PtpMarshallJCM8002203ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMarshallJCM8002203ToneStack"); };
    ...
    PointToPoint::MarshallJCM800_2203ToneStack effect;
