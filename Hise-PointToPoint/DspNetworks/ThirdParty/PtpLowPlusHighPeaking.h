...
template <int NV>
struct PtpLowPlusHighPeaking : public data::base
{
    SNEX_NODE(PtpLowPlusHighPeaking);

    struct MetadataClass { SN_NODE_ID("PtpLowPlusHighPeaking"); };
    ...
    PointToPoint::LowPlusHighPeaking effect;
    ...
    void createParameters(ParameterDataList& data)
    {
        ...
        {
            parameter::data p("Treble Frequency", { 0.0, 1.0 });
