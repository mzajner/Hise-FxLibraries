...
template <int NV>
struct PtpMarshallJCM8002210BoostToneStack : public data::base
{
    SNEX_NODE(PtpMarshallJCM8002210BoostToneStack);

    struct MetadataClass { SN_NODE_ID("PtpMarshallJCM8002210BoostToneStack"); };
    ...
    PointToPoint::MarshallJCM800_2210BoostToneStack effect;
