...
template <int NV>
struct PtpFenderBassman1002A : public data::base
{
    SNEX_NODE(PtpFenderBassman1002A);

    struct MetadataClass { SN_NODE_ID("PtpFenderBassman1002A"); };
    ...
    PointToPoint::FenderBassman100_2A effect;
