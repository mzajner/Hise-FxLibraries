...
template <int NV>
struct PtpLaneyLC15ToneStack : public data::base
{
    SNEX_NODE(PtpLaneyLC15ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpLaneyLC15ToneStack"); };
    ...
    PointToPoint::LaneyLC15ToneStack effect;
