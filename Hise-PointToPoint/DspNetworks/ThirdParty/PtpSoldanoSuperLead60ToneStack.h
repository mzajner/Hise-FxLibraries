...
template <int NV>
struct PtpSoldanoSuperLead60ToneStack : public data::base
{
    SNEX_NODE(PtpSoldanoSuperLead60ToneStack);

    struct MetadataClass { SN_NODE_ID("PtpSoldanoSuperLead60ToneStack"); };
    ...
    PointToPoint::SoldanoSuperLead60ToneStack effect;
