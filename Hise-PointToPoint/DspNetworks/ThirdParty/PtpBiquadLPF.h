...
template <int NV>
struct PtpBiquadLPF : public data::base
{
    SNEX_NODE(PtpBiquadLPF);

    struct MetadataClass { SN_NODE_ID("PtpBiquadLPF"); };
    ...
    {
        {
            parameter::data p("Q Increases Alongside Frequency In A Biquad", { 0.0, 1.0 });
