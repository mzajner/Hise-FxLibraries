...
#include "src/MoogLpf4Poles.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct MoogLpf4PolesMetaData {
		SN_NODE_ID("MoogLpf4Poles");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using MoogLpf4Poles = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _MoogLpf4Poles, MoogLpf4PolesMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
