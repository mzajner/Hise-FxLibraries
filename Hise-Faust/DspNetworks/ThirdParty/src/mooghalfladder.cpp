...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _mooghalfladder -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___mooghalfladder_H__
#define  ___mooghalfladder_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _mooghalfladder
#endif
...
static float _mooghalfladder_faustpower2_f(float value) {
	return value * value;
}

struct _mooghalfladder final : public ::faust::dsp {
	...
	_mooghalfladder(const _mooghalfladder&) = default;
	
	virtual ~_mooghalfladder() = default;
	
	_mooghalfladder& operator=(const _mooghalfladder&) = default;
	
	void metadata(Meta* m) { 
		m->declare("author", "Eric Tarr");
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _mooghalfladder -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		...
		m->declare("mooghalfladder.dsp/moogHalfLadder:author", "Eric Tarr");
		m->declare("mooghalfladder.dsp/moogHalfLadder:license", "MIT-style STK-4.3 license");
	...
	_mooghalfladder* clone() {
		return new _mooghalfladder(*this);
	}
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = 0.082328245f * (_mooghalfladder_faustpower2_f(fTemp0) * fTemp1 * fTemp3 / _mooghalfladder_faustpower2_f(fTemp2)) + 1.0f;
	...
	#define FAUST_FILE_NAME "mooghalfladder.dsp"
	#define FAUST_CLASS_NAME "_mooghalfladder"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _mooghalfladder -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
