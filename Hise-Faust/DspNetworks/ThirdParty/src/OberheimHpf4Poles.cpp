...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimHpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _OberheimHpf4Poles final : public ::faust::dsp {
	...
	_OberheimHpf4Poles(const _OberheimHpf4Poles&) = default;
	
	virtual ~_OberheimHpf4Poles() = default;
	
	_OberheimHpf4Poles& operator=(const _OberheimHpf4Poles&) = default;
	
	void metadata(Meta* m) { 
		m->declare("author", "Christopher Arndt, Eric Tarr");
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimHpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	_OberheimHpf4Poles* clone() {
		return new _OberheimHpf4Poles(*this);
	}
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimHpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
