...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _MicroShifter -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _MicroShifter final : public ::faust::dsp {
	...
	_MicroShifter(const _MicroShifter&) = default;
	
	virtual ~_MicroShifter() = default;
	
	_MicroShifter& operator=(const _MicroShifter&) = default;
	
	void metadata(Meta* m) { 
		m->declare("author", "Christophe Lebreton");
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _MicroShifter -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow4 = 0.0441f * std::max<float>(1e+01f, std::min<float>(1e+03f, static_cast<float>(fHslider2)));
		float fSlow5 = 2e-05f * std::max<float>(-1e+02f, std::min<float>(1e+02f, static_cast<float>(fHslider3)));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp5 = static_cast<int>(fRec4[0]);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fTemp1 * fTemp3 + fTemp2 * (fTemp4 * (fVec1[(IOTA0 - iTemp6) & 131071] * fTemp8 + fTemp9 * fVec1[(IOTA0 - iTemp10) & 131071]) + fTemp11 * (fVec1[(IOTA0 - iTemp14) & 131071] * fTemp16 + fTemp17 * fVec1[(IOTA0 - iTemp18) & 131071]))));
			float fTemp19 = static_cast<float>(input1[i0]);
			fVec3[IOTA0 & 131071] = fTemp19;
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fTemp19 * fTemp3 + fTemp2 * (fTemp4 * (fVec3[(IOTA0 - iTemp6) & 131071] * fTemp8 + fTemp9 * fVec3[(IOTA0 - iTemp10) & 131071]) + fTemp11 * (fTemp16 * fVec3[(IOTA0 - iTemp14) & 131071] + fTemp17 * fVec3[(IOTA0 - iTemp18) & 131071]))));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fVec0[1] = fVec0[0];
			fRec2[1] = fRec2[0];
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _MicroShifter -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
