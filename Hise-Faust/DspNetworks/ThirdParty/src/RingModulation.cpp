...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _RingModulation -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___RingModulation_H__
#define  ___RingModulation_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _RingModulation
#endif
...
struct _RingModulation final : public ::faust::dsp {
	...
	_RingModulation(const _RingModulation&) = default;
	
	virtual ~_RingModulation() = default;
	
	_RingModulation& operator=(const _RingModulation&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _RingModulation -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "RingModulation.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "RingModulation");
	...
	_RingModulation* clone() {
		return new _RingModulation(*this);
	}
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("RingModulation");
	...
	#define FAUST_FILE_NAME "RingModulation.dsp"
	#define FAUST_CLASS_NAME "_RingModulation"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _RingModulation -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
