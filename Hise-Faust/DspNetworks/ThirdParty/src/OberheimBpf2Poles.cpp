...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimBpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _OberheimBpf2Poles final : public ::faust::dsp {
	...
	_OberheimBpf2Poles(const _OberheimBpf2Poles&) = default;
	
	virtual ~_OberheimBpf2Poles() = default;
	
	_OberheimBpf2Poles& operator=(const _OberheimBpf2Poles&) = default;
	
	void metadata(Meta* m) { 
		m->declare("author", "Christopher Arndt, Eric Tarr");
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimBpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	_OberheimBpf2Poles* clone() {
		return new _OberheimBpf2Poles(*this);
	}
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimBpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
