/* ------------------------------------------------------------
name: "Pixelate_Broken"
Code generated with Faust 2.83.1 (https://faust.grame.fr)
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _Pixelate_Broken -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___Pixelate_Broken_H__
#define  ___Pixelate_Broken_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _Pixelate_Broken
#endif
...
struct _Pixelate_Broken final : public ::faust::dsp {
	...
	_Pixelate_Broken(const _Pixelate_Broken&) = default;
	
	virtual ~_Pixelate_Broken() = default;
	
	_Pixelate_Broken& operator=(const _Pixelate_Broken&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _Pixelate_Broken -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "Pixelate_Broken.dsp");
		m->declare("name", "Pixelate_Broken");
	...
	_Pixelate_Broken* clone() {
		return new _Pixelate_Broken(*this);
	}
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Pixelate_Broken");
	...
	#define FAUST_FILE_NAME "Pixelate_Broken.dsp"
	#define FAUST_CLASS_NAME "_Pixelate_Broken"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _Pixelate_Broken -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
