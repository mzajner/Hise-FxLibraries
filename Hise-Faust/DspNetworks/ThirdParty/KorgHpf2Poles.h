...
#include "src/KorgHpf2Poles.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct KorgHpf2PolesMetaData {
		SN_NODE_ID("KorgHpf2Poles");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using KorgHpf2Poles = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _KorgHpf2Poles, KorgHpf2PolesMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
