...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _flanger -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _flanger final : public ::faust::dsp {
	...
	_flanger(const _flanger&) = default;
	
	virtual ~_flanger() = default;
	
	_flanger& operator=(const _flanger&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _flanger -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = fConst1 * std::max<float>(0.0f, std::min<float>(1e+01f, static_cast<float>(fHslider1)));
		float fSlow3 = std::sin(fSlow2);
		float fSlow4 = std::cos(fSlow2);
		float fSlow5 = std::max<float>(-0.999f, std::min<float>(0.999f, static_cast<float>(fHslider2)));
		float fSlow6 = 0.001f * std::max<float>(0.0f, std::min<float>(2e+01f, static_cast<float>(fHslider3)));
		float fSlow7 = 0.0005f * std::max<float>(0.0f, std::min<float>(2e+01f, static_cast<float>(fHslider4)));
		float fSlow8 = std::max<float>(0.0f, std::min<float>(1.0f, static_cast<float>(fHslider5)));
		float fSlow9 = ((static_cast<int>(static_cast<float>(fCheckbox1))) ? -fSlow8 : fSlow8);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fRec0[0] = fSlow3 * fRec1[1] + fSlow4 * fRec0[1];
			fRec1[0] = static_cast<float>(1 - iVec0[1]) + fSlow4 * fRec1[1] - fSlow3 * fRec0[1];
			fHbargraph0 = static_cast<FAUSTFLOAT>(fRec1[0] + fRec0[0]);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : 0.5f * (fTemp1 + fRec2[0] * fSlow9)));
			...
			output1[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp6 : 0.5f * (fTemp7 + fRec3[0] * fSlow9)));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			IOTA0 = IOTA0 + 1;
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _flanger -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
