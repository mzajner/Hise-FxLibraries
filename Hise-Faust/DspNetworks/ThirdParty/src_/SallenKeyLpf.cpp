...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _SallenKeyLpf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _SallenKeyLpf final : public ::faust::dsp {
	...
	_SallenKeyLpf(const _SallenKeyLpf&) = default;
	
	virtual ~_SallenKeyLpf() = default;
	
	_SallenKeyLpf& operator=(const _SallenKeyLpf&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _SallenKeyLpf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _SallenKeyLpf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
