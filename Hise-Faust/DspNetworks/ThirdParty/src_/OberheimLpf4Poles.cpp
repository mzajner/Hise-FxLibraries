...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimLpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _OberheimLpf4Poles final : public ::faust::dsp {
	...
	_OberheimLpf4Poles(const _OberheimLpf4Poles&) = default;
	
	virtual ~_OberheimLpf4Poles() = default;
	
	_OberheimLpf4Poles& operator=(const _OberheimLpf4Poles&) = default;
	
	void metadata(Meta* m) { 
		m->declare("author", "Christopher Arndt, Eric Tarr");
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimLpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	_OberheimLpf4Poles* clone() {
		return new _OberheimLpf4Poles(*this);
	}
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _OberheimLpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
