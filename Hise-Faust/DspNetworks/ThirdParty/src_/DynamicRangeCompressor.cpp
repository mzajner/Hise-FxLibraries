...
Compilation options: -lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _DynamicRangeCompressor -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___DynamicRangeCompressor_H__
#define  ___DynamicRangeCompressor_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _DynamicRangeCompressor
#endif
...
struct _DynamicRangeCompressor final : public ::faust::dsp {
	...
	_DynamicRangeCompressor() {
	}
	
	_DynamicRangeCompressor(const _DynamicRangeCompressor&) = default;
	
	virtual ~_DynamicRangeCompressor() = default;
	
	_DynamicRangeCompressor& operator=(const _DynamicRangeCompressor&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _DynamicRangeCompressor -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		...
		m->declare("filename", "DynamicRangeCompressor.dsp");
	...
	void instanceResetUserInterface() {
		...
		fHslider2 = static_cast<FAUSTFLOAT>(6.5e+02f);
		fHslider3 = static_cast<FAUSTFLOAT>(225.0f);
	...
	_DynamicRangeCompressor* clone() {
		return new _DynamicRangeCompressor(*this);
	}
	...
	void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider3, FAUSTFLOAT(225.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(0.1f));
		...
		ui_interface->addHorizontalSlider("Release", &fHslider2, FAUSTFLOAT(6.5e+02f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(0.1f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = std::max<float>(fConst0, 0.001f * std::max<float>(1.0f, std::min<float>(1e+03f, static_cast<float>(fHslider2))));
	...
	#define FAUST_FILE_NAME "DynamicRangeCompressor.dsp"
	#define FAUST_CLASS_NAME "_DynamicRangeCompressor"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -fpga-mem-th 4 -rui -nvi -ct 1 -cn _DynamicRangeCompressor -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
	...
	FAUST_ADDHORIZONTALSLIDER("COMPRESSOR [tooltip: References:                 https://faustlibraries.grame.fr/libs/compressors/                 http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Attack", fHslider3, 225.0f, 1.0f, 1e+03f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("COMPRESSOR [tooltip: References:                 https://faustlibraries.grame.fr/libs/compressors/                 http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Release", fHslider2, 6.5e+02f, 1.0f, 1e+03f, 0.1f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, Attack, "COMPRESSOR [tooltip: References:                 https://faustlibraries.grame.fr/libs/compressors/                 http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Attack", fHslider3, 225.0f, 1.0f, 1e+03f, 0.1f) \
		p(HORIZONTALSLIDER, Release, "COMPRESSOR [tooltip: References:                 https://faustlibraries.grame.fr/libs/compressors/                 http://en.wikipedia.org/wiki/Dynamic_range_compression]/[1]/[4] Compression Response/Release", fHslider2, 6.5e+02f, 1.0f, 1e+03f, 0.1f) \
