...
#include "src/MoogLpf2Poles.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct MoogLpf2PolesMetaData {
		SN_NODE_ID("MoogLpf2Poles");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using MoogLpf2Poles = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _MoogLpf2Poles, MoogLpf2PolesMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
