...
#include "src/KorgLpf2Poles.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct KorgLpf2PolesMetaData {
		SN_NODE_ID("KorgLpf2Poles");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using KorgLpf2Poles = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _KorgLpf2Poles, KorgLpf2PolesMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
