...
#include "src/MicroShifter2.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct MicroShifter2MetaData {
		SN_NODE_ID("MicroShifter2");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using MicroShifter2 = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _MicroShifter2, MicroShifter2MetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
