...
#include "src/pitchShifter48.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct pitchShifter48MetaData {
		SN_NODE_ID("pitchShifter48");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using pitchShifter48 = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _pitchShifter48, pitchShifter48MetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
