...
#include "src/Compressor1176.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct Compressor1176MetaData {
		SN_NODE_ID("Compressor1176");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using Compressor1176 = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _Compressor1176, Compressor1176MetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
