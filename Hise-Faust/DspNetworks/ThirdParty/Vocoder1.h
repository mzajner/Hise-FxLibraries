...
#include "src/Vocoder1.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct Vocoder1MetaData {
		SN_NODE_ID("Vocoder1");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using Vocoder1 = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _Vocoder1, Vocoder1MetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
