...
with {
        ...
        *(makeupgain);
        ...
        `kicking in')]", 225, 1, 1000, 0.1):si.smoo) : *(0.001) : max(1/ma.SR);
        ...
        'releasing')]", 650, 1, 1000, 0.1):si.smoo) : *(0.001) : max(1/ma.SR);
