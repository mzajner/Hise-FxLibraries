...
dtime			= hslider("delay", 0.0001, 0, 0.05, 0.0001):si.smooth(0.999);
depth			= hslider("depth", 0.0002, 0, 0.1, 0.0001):si.smoo;
feedback		= hslider("feedback", 0.01, 0, 0.95, 0.001):si.smoo;
