...
pitchshifter = ef.transpose( hslider("window (samples)", 1000, 50, 100000, 1),
	                 hslider("Crossfade[style:knob][OWL:PARAMETER_C]", 10, 1, 10000, 1) : si.smoo,
	                 hslider("Pitch Shift[style:knob][OWL:PARAMETER_A]", 0, -12, +12, 1) +
	                 hslider("Super Pitch[style:knob][OWL:PARAMETER_E]", 0, 0, 12, 1)
		        );
