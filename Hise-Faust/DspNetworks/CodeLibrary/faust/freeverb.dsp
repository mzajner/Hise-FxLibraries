...
roomsizeSlider  = hslider("Room Size [OWL:PARAMETER_A]", 0.5, 0, 1, 0.025)*scaleroom + offsetroom:si.smoo;
dampSlider      = hslider("Damp [OWL:PARAMETER_B]",0.5, 0, 1, 0.025)*scaledamp:si.smoo;
wetSlider       = hslider("Dry/Wet [OWL:PARAMETER_D]", 0.99, 0, 1, 0.025);
