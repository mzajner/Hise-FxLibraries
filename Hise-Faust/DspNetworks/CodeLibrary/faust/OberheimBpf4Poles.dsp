...
oberheim(freq, Q) = _<:(s1,s2,s3,s4,ybpf) : !,!,!,!,_
letrec{
  's1 = _-s2:_-(s1*FBs1):_*alpha0:_*g<:_,(_+s1:ef.cubicnl(0.0,0)):>_;
  's2 = _-s2:_-(s1*FBs1):_*alpha0:_*g:_+s1:ef.cubicnl(0.0,0):_*g*2:_+s2;
  's3 = _-s4:_-(s3*FBs1):_*alpha0:_*g<:_,(_+s3:ef.cubicnl(0.0,0)):>_; // 
  's4 = _-s4:_-(s3*FBs1):_*alpha0:_*g:_+s3:ef.cubicnl(0.0,0):_*g*2:_+s4; // 
