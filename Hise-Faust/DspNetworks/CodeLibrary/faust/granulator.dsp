...
process = hgroup("Granulator", *(excitation : ampf)), hgroup("Granulator", *(excitation : ampf):si.smoo);
...
gain = 1;
freq = hslider("[1]Grain Size[style:knob][acc:2 0 -10 0 10]", 200,5,10000,1):si.smoo;
...
speed = hslider ("[2]Speed[unit:Hz][style:knob][acc:0 1 -10 0 10]", 10,1,20,0.0001):si.smoo; 
ratio_env = 0.5;
fade = (0.5); // min > 0 pour eviter division par 0
proba = hslider ("[3]Probability[unit:%][style:knob][acc:1 0 -10 0 10]", 70,20,100,1) * (0.01):si.smoo;
